...
const PCRCharts = (() => {
  ...
  function updateScore(score) {
    ...
    // score is null when there isn't enough real activity to compute an
    // honest ratio — show an explicit "not enough data" state instead of a
    // manufactured number.
    if (score === null || score === undefined) {
      ...
      statusEl.textContent = "STATUS: NEED MORE REPORTS";
      return;
    }
